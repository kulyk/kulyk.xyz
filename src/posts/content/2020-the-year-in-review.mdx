...
banner: 2020-the-year-in-review.png
...
<div style={{display: 'flex', justifyContent: 'space-between', paddingBottom: 24}}>
    <Image src="/2020-review/amsterdam.jpeg" alt="Amsterdam" width={250} height={340} />
    <Image src="/2020-review/van-gogh.jpeg" alt="Sunflowers by Vincent van Gogh" width={250} height={340} />
    <Image src="/2020-review/morrissey.jpeg" alt="Ticket to Morrissey's concert" width={250} height={340} />
</div>
...
<Image
  src="/2020-review/studio.jpeg"
  alt="Me at the recording studio"
  width={800}
  height={600}
/>
